...
- Challenge A: Bouncing Object (dengan perubahan warna dinamis saat memantul)
- Challenge B: Follow Mouse & Slingshot Line Indicator
- Challenge C: Click to Change Color
- Challenge D: Keyboard Movement (State-Based) + Reset Posisi (Event-Based 'R')
- Challenge E: Real-time Mouse Coordinate Display
- Challenge Tambahan 1: Click to Create Circle
- Challenge Tambahan 2: Trail Mode Selector (Trail vs No Trail)
*/
...
window.addEventListener("keydown", function (event) {
  ...
  // State-based: simpan status tombol untuk translasi kontinu
  keys[event.key] = true;

  // Event-based: contoh aksi diskrit sekali tekan (reset posisi)
...
function animate() {
  ...
  drawLineToMouse(firstClickX, firstClickY);
